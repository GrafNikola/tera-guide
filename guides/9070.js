...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	function boss_message_event(skillid) {
		...
		if (skillid === 213) {
			handlers.text({
				...
				message_RU: is_telling_truth() ? bossActions_RU[213].truth : bossActions_RU[213].lie
			});
		}
		...
		if (skillid === 212) {
			handlers.text({
				...
				message_RU: is_telling_truth() ? bossActions_RU[212].truth : bossActions_RU[212].lie
			});
		}
		...
		if (skillid === 218) {
			handlers.text({
				...
				message_RU: is_telling_truth() ? bossActions_RU[218].truth : bossActions_RU[218].lie
			});
		}
	}
	...
	return {
		...
		"qb-470-600-470053": [{ type: "text", sub_type: "message", message: "Start", message_RU: "Начать" }]
	};
};
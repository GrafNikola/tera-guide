...
module.exports = (dispatch, handlers, guide, lang) => {
	return {
		...
		"s-939-2000-108-0": [{ type: "text", sub_type: "message", message: "Clense", message_RU: "Клинс", class_position: "heal" }],
		"s-939-2000-115-0": [
		...
		"s-939-2000-303-0": [{ type: "text", sub_type: "message", message: "Whip", message_RU: "Кнут" }],
		...
		"s-939-3001-201-0": [{ type: "text", sub_type: "message", delay: 3600, message: "Dodge!", message_RU: "Эвейд!" }],

...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3106-1000-202-0": [{ type: "text", sub_type: "message", message: "Front", message_RU: "Удар вперед" }],
		"s-3106-1000-203-0": [{ type: "text", sub_type: "message", message: "Front + Wave", message_RU: "Удар вперед + волна" }],

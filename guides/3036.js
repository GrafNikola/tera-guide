...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	const mech_messages = {
		0: { message: "Three Split Strikes", message_RU: "Три откида" },
		1: { message: "Four Split Strikes", message_RU: "Четыре откида" },
	...
	return {
		...
		"s-3036-1000-1112-0": [{ type: "text", sub_type: "message", message: "Back", message_RU: "Удар вперед" }],
		"s-3036-1000-1117-0": [{ type: "text", sub_type: "message", message: "Front", message_RU: "Удар назад" }],
		...
		"s-3036-1000-1805-0": [
			{ type: "text", sub_type: "message", message: "Between -> In -> All -> Out", message_RU: "Между -> К нему -> Общая -> От него" },
		...
		"s-3036-1000-1806-0": [
			{ type: "text", sub_type: "message", message: "In -> Between -> All -> In", message_RU: "К нему -> Между -> Общая -> К нему" },
		...
		"s-3036-1000-2112-0": [{ type: "text", sub_type: "message", message: "Back", message_RU: "Удар назад" }],

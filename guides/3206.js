...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3206-1000-201-0": [{ type: "text", sub_type: "message", message: "Front Attack", message_RU: "Удар вперед" }],
		"s-3206-1000-202-0": [{ type: "text", sub_type: "message", message: "Front Attack", message_RU: "Удар вперед" }],
		"s-3206-1000-203-0": [{ type: "text", sub_type: "message", message: "Front Attack", message_RU: "Удар вперед" }],
		...
		"s-3206-1000-209-0": [{ type: "text", sub_type: "message", message: "Stomp (Knockdown)", message_RU: "Опрокид" }],
		"s-3206-1000-210-0": [{ type: "text", sub_type: "message", message: "Stomp (Knockdown)", message_RU: "Опрокид" }],
		...
		"s-3206-1000-310-0": [{ type: "text", sub_type: "message", message: "Front Attack", message_RU: "Удар вперед" }],
		"s-3206-1000-311-0": [{ type: "text", sub_type: "message", message: "Front Attack", message_RU: "Удар вперед" }],

...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"h-3046-1000-80": [{ type: "text", sub_type: "message", message: "80%", message_RU: "80%" }],
		"h-3046-1000-35": [{ type: "text", sub_type: "message", message: "35%", message_RU: "35%" }],
		...
		"s-3046-1000-106-0": [{ type: "text", sub_type: "message", message: "Blades Front", message_RU: "Лезвия вперед" }],
		"s-3046-1000-112-0": [
		...
		"s-3046-1000-119-0": [{ type: "text", sub_type: "message", message: "Cut", message_RU: "Разрез" }],
		"s-3046-1000-120-0": [{ type: "text", sub_type: "message", message: "Storm", message_RU: "Шторм" }],
		"s-3046-1000-107-0": [
		...
		"s-3046-1000-117-0": [{ type: "text", sub_type: "message", message: "Kick", message_RU: "Удар ногой" }],
		"s-3046-1000-118-0": [{ type: "text", sub_type: "message", message: "Kick (Dodge)", message_RU: "Удар ногой (эвейд)" }],
		...
		"qb-3046-1000-30461002": [{ type: "text", sub_type: "message", message: "Shield!", message_RU: "Щит!" }], // <50%
		"s-3046-1000-123-0": [{ type: "text", sub_type: "message", message: "Break Failure", message_RU: "Щит не пробит" }],

		"qb-3046-1000-30461004": [{ type: "text", sub_type: "message", message: "Bait (Lasers)", message_RU: "Байт (лазеры)" }], // range check
		"qb-3046-1000-30461005": [{ type: "text", sub_type: "message", message: "Bait", message_RU: "Байт" }], // get stun
		"qb-3046-1000-30461006": [{ type: "text", sub_type: "message", message: "Bait", message_RU: "Байт" }], // cast ress
		"qb-3046-1000-30461007": [{ type: "text", sub_type: "message", message: "Puddles", message_RU: "Лужи" }], // <40%
		...
		"s-3046-1000-121-0": [{ type: "text", sub_type: "message", message: "AoE", message_RU: "АоЕ" }], // red
		"s-3046-1000-122-0": [{ type: "text", sub_type: "message", message: "AoE", message_RU: "АоЕ" }], // blue

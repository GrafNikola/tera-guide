...
module.exports = {
  ...
  //  "h-3201-1000-100": [{"type": "func","func": guid_voice}],
    ...
    "s-3201-1000-313-0": [{"type": "text","sub_type": "msgcp","message": "Circles (Slow)","message_RU": "Кольцо"},
 ...
 //   "s-3201-2000-107-0": [{"type": "text","class_position":"tank","sub_type": "message","message": "left","message_RU": "左手" }],	
   ...
   "am-3201-2000-32010220": [{"type": "text","sub_type": "notification","message": "next false","message_RU": "след лож" },{"type": "func","func": skilld_event.bind(null, 32010220)}],		
   ...
   // "s-3201-2000-226-0": [{"type": "text","sub_type": "message","message_RU": "空中吸收 蓄力" }],	
    ...
    "s-3201-2000-231-0": [{"type": "text","sub_type": "msgcp","message": "OUT safe ↓","message_RU": "От"},{"type": "func","func": Spawnitem2.bind(null,912,0,0,15,300,3000)}],	
    "s-3201-2000-232-0": [{"type": "text","sub_type": "msgcp","message": "IN safe ↑","message_RU": "К"},

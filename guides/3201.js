...
module.exports = {
 ...
 //   "s-3201-2000-107-0": [{"type": "text","class_position":"tank","sub_type": "message","message": "left","message_RU": "左手" }],	
   ...
   // "s-3201-2000-226-0": [{"type": "text","sub_type": "message","message_RU": "空中吸收 蓄力" }],	
    ...
    "s-3201-2000-231-0": [{"type": "text","sub_type": "msgcp","message": "OUT safe ↓","message_RU": "От"},
						{"type": "text","sub_type": "message","message": "OUT","message_RU": "Эвейд"
    ...
    "s-3201-2000-232-0": [{"type": "text","sub_type": "msgcp","message": "IN safe ↑","message_RU": "К"},
						{"type": "text","sub_type": "message","message": "IN safe","message_RU": "К"},
						{"type": "func","func": Spawnitem2.bind(null,912,0,0,15,300,3000)},

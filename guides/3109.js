...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3109-2000-405-0": [
			{ type: "text", sub_type: "message", message: "Back Slam", message_RU: "Удар назад", delay: 1250 },
		...
		"s-3109-2000-407-0": [{ type: "text", sub_type: "message", message: "Back | Front Attack", message_RU: "Задняя | Передняя" }],
		"s-3109-2000-409-0": [
		...
		"s-3109-2000-410-0": [
			{ type: "text", sub_type: "message", message: "Back Slam", message_RU: "Удар назад" },
			{ type: "spawn", func: "circle", args: [false, 553, 160, 425, 12, 250, 0, 1500] },
			{ type: "spawn", func: "circle", args: [false, 553, 200, 425, 12, 250, 0, 1500] }
		],
		"s-3109-2000-411-0": [{ type: "text", sub_type: "message", message: "Back | Front Attack", message_RU: "Задняя | Передняя" }],
		// In - Out
		"s-3109-2000-412-0": [
			{ type: "text", sub_type: "message", message: "Spin | Out", message_RU: "Крутилка | От него" },
		...
		"s-3109-2000-604-0": [
			{ type: "text", sub_type: "message", message: "Get In", message_RU: "Внутрь" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 400, 0, 10000] }
		],
		"s-3109-2000-605-0": [{ type: "text", sub_type: "message", message: "Pizza | Out-In", message_RU: "Пицца | От него - К нему", delay: 5000 }],
		"s-3109-2000-606-0": [
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 400, 0, 5000] },
		...
		// Waves
		"s-3109-2000-616-0": [{ type: "text", sub_type: "message", message: "Inward Wave", message_RU: "Волна" }],
		"s-3109-2000-617-0": [{ type: "text", sub_type: "message", message: "Front | Back Waves", message_RU: "Передняя | Волны назад" }]
	};
};
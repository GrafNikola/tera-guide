...
module.exports = (dispatch, handlers, guide, lang) => {
	return {
		...
		"s-983-1000-119-0": [{ type: "text", sub_type: "message", message: "Heavy Attack", message_RU: "Тяжелый удар" }],
		"s-983-1000-120-0": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд" }],
		"s-983-1000-302-0": [{ type: "text", sub_type: "message", message: "AOE", message_RU: "АОЕ" }],
		"s-983-1000-108-0": [{ type: "text", sub_type: "message", message: "Stun", message_RU: "Стан" }],
		...
		"s-983-2000-306-0": [{ type: "text", sub_type: "message", message: "Dodge | Out", message_RU: "Эвейд | От него" }],
		// { type: "spawn", func: "circle", args: [false, 553, 0, -50, null, 675, 0, 3000] }
		"s-983-2000-317-0": [{ type: "text", sub_type: "message", message: "Dodge (AOE)", message_RU: "Эвейд (АОЕ)" }],
		"s-983-2000-318-0": [{ type: "text", sub_type: "message", message: "Dodge (Get out)", message_RU: "Эвейд (отбежать)" }],
		...
		"s-983-3000-106-0": [{ type: "text", sub_type: "message", message: "Push", message_RU: "Откид" }],
		"s-983-3000-309-0": [{ type: "text", sub_type: "message", message: "Debuff!!!", message_RU: "Дебафф!!!" }],
		...
		"s-983-3000-315-0": [{ type: "text", sub_type: "message", message: "Dodge | Out", message_RU: "Эвейд | От него" }],
		...
		"s-983-3000-124-0": [{ type: "text", sub_type: "message", message: "AoE", message_RU: "АоЕ" }],
		...
		"s-983-3000-301-0": [{ type: "text", sub_type: "message", message: "Circles (Target)", message_RU: "Шипы х5 (Эвейд)" }],
		"s-983-3000-303-0": [

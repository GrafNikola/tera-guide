...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-983-1000-101-0": [{ type: "text", sub_type: "message", message: "Stun", message_RU: "Кувырок (стан)", check_func: () => firstboss_prepare_stun }],
		"s-983-1000-102-0": [
		...
		"s-983-2000-114-0": [{ type: "text", sub_type: "message", message: "Ground Hit", message_RU: "Удар в землю" }],

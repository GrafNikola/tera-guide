...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-980-1000-112-0": [{ type: "text", sub_type: "message", message: "Jump Fowrard", message_RU: "Прыжок вперед" }],
		...
		"s-980-3000-113-0": [{ type: "text", sub_type: "message", message: "Pushback", message_RU: "Откид назад" }], // left
		"s-980-3000-114-0": [{ type: "text", sub_type: "message", message: "Pushback", message_RU: "Откид назад" }], // right

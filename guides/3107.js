...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3107-1000-112-0": [
			{ type: "text", sub_type: "message", message: "Inner + Outer Bombs", message_RU: "Ближние + дальние бомбы" },
		...
		"s-3107-1000-113-0": [
			{ type: "text", sub_type: "message", message: "Inner Bombs", message_RU: "Ближние бомбы" },
			{ type: "spawn", func: "circle", args: [false, 553, 45, 180, 12, 230, 0, 3000] },
			{ type: "spawn", func: "circle", args: [false, 553, 135, 180, 12, 230, 0, 3000] },
			{ type: "spawn", func: "circle", args: [false, 553, 225, 180, 12, 230, 0, 3000] },
			{ type: "spawn", func: "circle", args: [false, 553, 315, 180, 12, 230, 0, 3000] }
		],
		"s-3107-1000-302-0": [{ type: "text", sub_type: "message", message: "Shield", message_RU: "Щит" }],
		...
		"s-3107-1000-310-0": [{ type: "text", sub_type: "message", message: "Break Stones", message_RU: "Разбить пилоны" }],
		"s-3107-1000-311-0": "s-3107-1000-310-0",
		"s-3107-1000-320-0": [{ type: "text", sub_type: "message", message: "Pizza (Pushback)", message_RU: "Пицца (откид)" }], // forward
		"s-3107-1000-321-0": [{ type: "text", sub_type: "message", message: "Pizza (Pushback)", message_RU: "Пицца (откид)" }], // reverse
		"s-3107-1000-322-0": [{ type: "text", sub_type: "message", message: "Pizza Spin (Pushback)", message_RU: "Пицца по кругу (откид)" }], // forward
		"s-3107-1000-323-0": [{ type: "text", sub_type: "message", message: "Pizza Spin (Pushback)", message_RU: "Пицца по кругу (откид)" }], // reverse
		...
		"s-3107-1000-370-0": [
			{ type: "text", sub_type: "message", message: "Cross (Target)", message_RU: "Кресты (таргет)" },
			{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд", delay: 3000 }
		],
		"qb-3107-1000-31070003": [
			{ type: "text", sub_type: "message", message: "Circles (Target)", message_RU: "Круги (таргет)" },
			{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд", delay: 2500 }
		],
		"qb-3107-1000-31070010": [{ type: "text", sub_type: "message", message: "Pizza (Pushback)", message_RU: "Пицца (откид)" }],

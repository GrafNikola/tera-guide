...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-2800-3000-1130-0": [{ type: "text", sub_type: "message", "message": "LEFT SWIPE", message_RU: "Удар вправо" },
		...
		"s-2800-3000-1131-0": [{ type: "text", sub_type: "message", "message": "RIGHT SWIPE", message_RU: "Удар влево" },
			{ "type": "spawn", "sub_type": "build_object", "id": 1, "sub_delay": 2000, "distance": 200, "offset": -2.3, "ownerName": "Сюда!", "message": "БлекДжека" },
			{ "type": "spawn", "sub_type": "build_object", "id": 1, "sub_delay": 2000, "distance": 200, "offset": -1, "ownerName": "Сюда!", "message": "БлекДжека" },
			{ "type": "spawn", "sub_type": "item", "id": 98260, "sub_delay": 2000, "distance": 200, "offset": -2.3 },
			{ "type": "spawn", "sub_type": "item", "id": 98260, "sub_delay": 2000, "distance": 200, "offset": -1 }],
		...
		"s-2800-4000-1108-0": [{ type: "text", sub_type: "message", message: "Lines", message_RU: "Линии" },
		...
		"s-2800-5000-1103-0": [{ type: "text", sub_type: "message", message: "Tail", message_RU: "Хвост" },
		...
		"s-2800-5000-1104-0": [{ type: "text", sub_type: "message", message: "Ice Storm DOTs", message_RU: "Ледяные лужи" },
		...
		"s-2800-5000-1107-0": [{ type: "text", sub_type: "message", message: "Change", message_RU: "Смена" },
		...
		"s-2800-5000-1120-0": [{ type: "text", sub_type: "message", message: "Stun + reclining", message_RU: "Стан + откид" },
		...
		"s-2800-6000-1101-0": [{ type: "text", sub_type: "message", message: "Blow from the ground", message_RU: "Удар из под земли" },
			{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд", delay: 1000 }],
		"s-2800-6000-1103-0": [{ type: "text", sub_type: "message", message: "Impact", message_RU: "Удар" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 225, 0, 425, 0, 3000] }],
		"s-2800-6000-1104-0": [{ type: "text", sub_type: "message", message: "Impact", message_RU: "Удар + взмах" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 225, 0, 375, 0, 3000] }],
		"s-2800-6000-1106-0": [{ type: "text", sub_type: "message", message: "Series + Impact", message_RU: "Серия + Удар" },
		...
		"s-2800-6000-1109-0": [{ type: "text", sub_type: "message", message: "1 strike", message_RU: "1 удар" },
		...
		"s-2800-6000-1110-0": [{ type: "text", sub_type: "message", message: "2 strikes", message_RU: "2 удара" },
			{ type: "spawn", func: "semicircle", args: [-160, 105, 553, 0, 0, null, 550, 0, 3000] },
			{ type: "spawn", func: "vector", args: [553, 0, 0, -160, 550, 0, 3000] },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 105, 550, 0, 3000] },
			{ "type": "spawn", "sub_type": "build_object", "id": 1, "sub_delay": 3000, "distance": 350, "offset": 2.6, "ownerName": "Сюда!", "message": "БлекДжека" },
		...
		"s-2800-6000-1133-0": [{ type: "text", sub_type: "message", message: "Strike", message_RU: "Удар" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 225, 0, 475, 0, 3000] }],
		"s-2800-6000-1134-0": [{ type: "text", sub_type: "message", message: "Impact", message_RU: "Удар + взмах" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 225, 0, 475, 0, 3000] }],
		...
		"h-2800-7000-99": [{ type: "func", func: () => thirdboss_fifty = false }],
		"h-2800-7000-50": [{ type: "func", func: () => thirdboss_fifty = true }],
		...
		"s-2800-7000-1105-0": [{ type: "text", sub_type: "message", message: "Discarding", message_RU: "Откид пятка" },
		...
		"s-2800-7000-1130-0": [{ type: "text", sub_type: "message", message: "Shield Strike", message_RU: "Удар щитом" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 130, 0, 270, 0, 2500] }],
		"s-2800-7000-1132-0": [{ type: "text", sub_type: "message", message: "AOE Shield", message_RU: "АОЕ щитом!" },
			{ type: "spawn", func: "semicircle", args: [-65, 65, 553, 0, 0, null, 600, 0, 3000] },
			{ type: "spawn", func: "vector", args: [553, 0, 40, -65, 600, 0, 3000] },
			{ type: "spawn", func: "vector", args: [553, 0, 40, 65, 600, 0, 3000] }],
		"s-2800-7000-1133-0": [{ type: "text", sub_type: "message", message: "AOE Shield", message_RU: "АОЕ щитом!" },
		...
		"s-2800-7000-1152-0": [{ type: "text", sub_type: "message", message: "Stun + Back", message_RU: "Стан + Откид назад" },
		...
		"s-2800-7000-1140-0": [{ type: "text", sub_type: "message", message: "Donuts", message_RU: "Бублики!" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 0, 200, 0, 6000] },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 0, 380, 0, 6000] },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 0, 520, 0, 6000] },
		...
		"s-2800-7000-1154-0": [{ "type": "text", "sub_type": "message", "message": "OUT + IN", message_RU: "От него => К нему" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 10, 0, 250, 0, 3000] }],
		"s-2800-7000-1155-0": [{ "type": "text", "sub_type": "message", "message": "IN + OUT", message_RU: "К нему => От него" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 10, 0, 250, 0, 3000] }],
		"s-2800-7000-1142-0": [{ "type": "spawn", "sub_type": "build_object", "id": 1, "sub_delay": 4000, "distance": 525, "offset": 2.8, "ownerName": "Сюда!", "message": "БлекДжека" },
			{ "type": "spawn", "sub_type": "build_object", "id": 1, "sub_delay": 4000, "distance": 525, "offset": 3.46, "ownerName": "Сюда!", "message": "БлекДжека" },
			{ "type": "spawn", "sub_type": "build_object", "id": 1, "sub_delay": 4000, "distance": 525, "offset": 4.12, "ownerName": "Сюда!", "message": "БлекДжека" },
			{ "type": "spawn", "sub_type": "build_object", "id": 1, "sub_delay": 4000, "distance": 525, "offset": 4.75, "ownerName": "Сюда!", "message": "БлекДжека" },
			{ "type": "spawn", "sub_type": "build_object", "id": 1, "sub_delay": 4000, "distance": 525, "offset": 5.38, "ownerName": "Сюда!", "message": "БлекДжека" },
		...
		"s-2800-7000-1901-0": [{ type: "text", sub_type: "message", message: "(Debuffs) Closest", message_RU: "Дебафф (ближние)" },
			{ type: "func", func: seventh_spawn_tables.bind(null) }],
		"s-2800-7000-1902-0": [{ type: "text", sub_type: "message", message: "(Debuffs) Farthest", message_RU: "Дебафф (дальние)" },
			{ type: "func", func: seventh_spawn_tables.bind(null) }],
		"s-2800-7000-1903-0": [{ type: "text", sub_type: "message", message: "(Bombs) Gather + Cleanse", message_RU: "Бомбы (вместе!) + клинс" },
			{ type: "func", func: seventh_spawn_tables.bind(null) }],
		"s-2800-7000-1904-0": [{ type: "text", sub_type: "message", message: "(Bombs) Gather + No cleanse", message_RU: "Бомбы (вместе!) + БЕЗ клинса" },
			{ type: "func", func: seventh_spawn_tables.bind(null) }],
		"s-2800-7000-1905-0": [{ type: "text", sub_type: "message", message: "(Circles) Spread", message_RU: "Круги (отдельно!)" },
			{ type: "func", func: seventh_spawn_tables.bind(null) }],
		"s-2800-7000-1906-0": [{ type: "text", sub_type: "message", message: "(Circles) Gather", message_RU: "Круги (вместе!)" },
			{ type: "func", func: seventh_spawn_tables.bind(null) }],


		"s-2800-7000-1144-0": [{ "type": "text", "sub_type": "message", "message": "OUT", message_RU: "От него" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 10, 0, 250, 0, 3000] }],
		"s-2800-7000-1145-0": [{ "type": "text", "sub_type": "message", "message": "IN", message_RU: "К нему" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 10, 0, 250, 0, 3000] }],
		...
		//Eighth floor
		"s-2800-8000-1102-0": [{ type: "text", sub_type: "message", message: "Pull in 5 sec", message_RU: "Скоро стяжка" },
			{ type: "text", sub_type: "message", message: "Pull", message_RU: "Стяжка", delay: 4500 }],
		"s-2800-8000-2102-0": [{ type: "text", sub_type: "message", message: "Pull in 5 sec", message_RU: "Скоро стяжка" },
			{ type: "text", sub_type: "message", message: "Pull", message_RU: "Стяжка", delay: 3500 }],

		"s-2800-8000-1101-0": [{ type: "text", sub_type: "message", message: "Soon AOE", message_RU: "Скоро АОЕ" },

...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-780-2000-107-0": [{ type: "text", sub_type: "message", message: "Velika ji lower gate / prokion / stone Chak attack / longAtk02 / normal" }],
		...
		"s-780-3000-110-0": [{ type: "text", sub_type: "message", message: "Velika ji lower gate / beldegg / acid phase attack | LongAtk01 / normal" }],

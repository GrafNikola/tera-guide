...
module.exports = {
	...
	"s-781-1000-2304-0": [{"type": "text","sub_type": "message","message": "Flying","message_RU": "Взлет"}].concat(SPAWNING_FIRST_CIRCLE_FLOWERS),
	...
	"s-781-1000-1304-0": [{"type": "text","sub_type": "message","message": "Flying","message_RU": "Взлет"}].concat(SPAWNING_FIRST_CIRCLE_FLOWERS),
	...
	"qb-781-1000-78103": [{"type": "text","sub_type": "message","message": "点名炸石柱","message_RU": "4 点名炸石柱"}],
	"qb-781-1000-78102": [{"type": "text","sub_type": "message","message": "Run away","message_RU": "Уходи!"}],
	"qb-781-1000-78106": [{"type": "text","sub_type": "message","message": "集体炸石柱","message_RU": "6 集体炸石柱"}],


	// 2 BOSS

	// Cage Mechanic
	"s-781-2000-1503-0": [{"type": "text","sub_type": "message","message": "坦快跑远","message_RU": "1 坦快跑远"}],
	...
	"s-781-2000-1111-0": [{"type": "text","sub_type": "message","message": "360 attack","message_RU": "Атака на 360 град."}],
	"s-781-2000-1302-0": [{"type": "text","sub_type": "message","message": "点名","message_RU": "2 点名"}],
	"s-781-2000-1121-0": [{"type": "text","sub_type": "message","message": "召唤小怪快打","message_RU": "3 召唤小怪快打"}],
	"s-781-2000-1501-0": [
	...
	"s-781-2000-1131-0": [{"type": "text","sub_type": "message","message": "right","message_RU": "Вправо >"},
		{"type":"spawn", "sub_type": "build_object", "id": 1, "sub_delay": 2000, "distance": 100, "offset": -2.3, "ownerName": "SAFE SPOT", "message": "SAFE"},
		{"type":"spawn", "sub_type": "build_object", "id": 1, "sub_delay": 2000, "distance": 100, "offset": -1, "ownerName": "SAFE SPOT", "message": "SAFE"},
		{"type":"spawn", "sub_type": "item", "id": 98260, "sub_delay": 2000, "distance": 100, "offset": -2.3},
		{"type":"spawn", "sub_type": "item", "id": 98260, "sub_delay": 2000, "distance": 100, "offset": -1}
	],
	"s-781-2000-1134-0": [{"type": "func","func": single_stage_callout.bind(null, "5 吃注视")}],
	"s-781-2000-1502-0": [{"type": "func","func": single_stage_callout.bind(null, "6 鉴定准备")}],
	//
	"s-781-2000-2503-0": [{"type": "text","sub_type": "message","message": "坦快跑远","message_RU": "1 坦快跑远"}],
	...
	"s-781-2000-2111-0": [{"type": "text","sub_type": "message","message": "360 attack","message_RU": "Атака на 360 град."}],
	"s-781-2000-2121-0": [{"type": "text","sub_type": "message","message": "召唤小怪快打","message_RU": "3 召唤小怪快打"}],
	"s-781-2000-2501-0": [
		{"type": "text","sub_type": "message","message": "Identification","message_RU": "Идентификация"},
		{"type": "text","sub_type": "message","delay": 1000,"message": "3"},
		{"type": "text","sub_type": "message","delay": 2000,"message": "2"},
	...
	"s-781-2000-2130-0": [{"type": "text","sub_type": "message","message": "left","message_RU": "< Влево"},
		{"type":"spawn", "sub_type": "build_object", "id": 1, "sub_delay": 2000, "distance": 100, "offset": 2.3, "ownerName": "SAFE SPOT", "message": "SAFE"},
		{"type":"spawn", "sub_type": "build_object", "id": 1, "sub_delay": 2000, "distance": 100, "offset": 1, "ownerName": "SAFE SPOT", "message": "SAFE"},
		{"type":"spawn", "sub_type": "item", "id": 98260, "sub_delay": 2000, "distance": 100, "offset": 2.3},
		{"type":"spawn", "sub_type": "item", "id": 98260, "sub_delay": 2000, "distance": 100, "offset": 1}
	],
	"s-781-2000-2131-0": [{"type": "text","sub_type": "message","message": "right","message_RU": "Вправо >"},
		{"type":"spawn", "sub_type": "build_object", "id": 1, "sub_delay": 2000, "distance": 100, "offset": -2.3, "ownerName": "SAFE SPOT", "message": "SAFE"},
		{"type":"spawn", "sub_type": "build_object", "id": 1, "sub_delay": 2000, "distance": 100, "offset": -1, "ownerName": "SAFE SPOT", "message": "SAFE"},
		{"type":"spawn", "sub_type": "item", "id": 98260, "sub_delay": 2000, "distance": 100, "offset": -2.3},
		{"type":"spawn", "sub_type": "item", "id": 98260, "sub_delay": 2000, "distance": 100, "offset": -1}
	],
	"s-781-2000-2134-0": [{"type": "func","func": single_stage_callout.bind(null, "5 吃注视")}],
	"s-781-2000-2502-0": [{"type": "func","func": single_stage_callout.bind(null, "6 鉴定准备")}],
	"s-781-2000-4000-0": [{"type": "text","sub_type": "alert","message": "鉴定！！！！","message_RU": "7 鉴定！！！！"}].concat(dlw_object),
	
	"dm-0-0-9781022": [{"type": "text","sub_type": "alert","message": "鉴定","message_RU": "8 鉴定"}],
	"dm-0-0-9781023": [{"type": "text","sub_type": "message","message": "全场鉴定","message_RU": "8 全场鉴定"}],
	"dm-0-0-9781046": [{"type": "text","sub_type": "message","message": "(Debuffs) Closest","message_RU": "Первая: дебафф (ближние)"}],
	"dm-0-0-9781047": [{"type": "text","sub_type": "message","message": "(Circles) Spread","message_RU": "Первая: круги (отдельно)"}],
	"dm-0-0-9781048": [{"type": "text","sub_type": "message","message": "(Bombs) Gather + cleanse","message_RU": "Первая: бомбы (вместе + клинс)"}],

	// 3 BOSS

	"s-781-3000-1404-0": [{"type": "text","sub_type": "message","message": "(Debuffs) Closest","message_RU": "Дебафф (ближние)"}].concat(lasers_markers_seventhfloor),
	"s-781-3000-1405-0": [{"type": "text","sub_type": "message","message": "(Debuffs) Farthest","message_RU": "Дебафф (дальние)"}].concat(inverted_lasers_markers_seventhfloor),//
	"s-781-3000-1301-0": [{"type": "text","sub_type": "message","message": "(Bombs) Gather + cleanse","message_RU": "Бомбы (вместе!) + клинс"},].concat(lasers_markers_seventhfloor),
	"s-781-3000-1302-0": [{"type": "text","sub_type": "message","message": "(Bombs) Gather + no cleanse","message_RU": "Бомбы (вместе!) + без клинса"},].concat(inverted_lasers_markers_seventhfloor),//
	"s-781-3000-3103-0": [{"type": "text","sub_type": "message","message": "(Circles) Spread","message_RU": "Круги (отдельно!)"},].concat(lasers_markers_seventhfloor),
	"s-781-3000-3105-0": [{"type": "text","sub_type": "message","message": "(Circles) Gather","message_RU": "Круги (вместе!)"},].concat(inverted_lasers_markers_seventhfloor),//
	"s-781-3000-1116-0": [{"type": "text","sub_type": "message","message": "Circle","message_RU": "Круг"}],
	...
	"s-781-3000-1113-0": [{"type": "text","sub_type": "message","message_RU": "Объявление"}],
	"s-781-3000-1151-0": [{"type": "text","sub_type": "message","message": "attention stun","message_RU": "Возможен стан"}],
	"s-781-3000-2151-0": [{"type": "text","sub_type": "message","message": "attention stun","message_RU": "Возможен стан"}],
	"s-781-3000-2113-0": [{"type": "text","sub_type": "message","message_RU": "Объявление"}],
	"s-781-3000-1152-0": [{"type": "text","sub_type": "message","message": "Stun + Back","message_RU": "Стан + Назад"}],
	"s-781-3000-2152-0": [{"type": "text","sub_type": "message","message": "Stun + Back","message_RU": "Стан + Назад"}],
	...
	"s-781-3000-1240-0": [{"type": "text","sub_type": "message","message": "Donuts","message_RU": "Бублики"}].concat(SPAWNING_THIRD_CIRCLE_FLOWERS),

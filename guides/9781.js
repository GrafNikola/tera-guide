...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-781-1000-1301-0": [{ type: "text", sub_type: "message", message: "AOE (Go to the safe)", message_RU: "АОЕ (отойти в сейф зону)" }],
		...
		"qb-781-2000-468036": [{ type: "text", sub_type: "message", message: "Mobs Summon", message_RU: "Призыв мобов" }],
		// Pizza Mechanic

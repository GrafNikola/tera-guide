...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-770-3000-1322-0": [{ type: "text", sub_type: "message", message: "Dodge!", message_RU: "Эвейд!" }],
		"s-770-3000-1311-0": [{ type: "text", sub_type: "message", message: "Gather for Cleanse!", message_RU: "Клинс!" }],
		"s-770-3000-1120-0": [{ type: "text", sub_type: "message", message: "Shooting Skulls", message_RU: "Лазеры" }],
		"s-770-3000-2120-0": [{ type: "text", sub_type: "message", message: "Shooting Skulls", message_RU: "Лазеры" }]
	};
};
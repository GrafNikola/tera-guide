...
const debuff_TipMsg =
{
	0: {msg: 'Готовность к переключению на красный'},
	1: {msg: 'Готовность к переключению на синий'}
};
const boss_skill =
{
...
module.exports = {
	...
	"s-3026-1000-1112-0": [{"type": "text","sub_type": "message","message": "Air-conditioned DOT (away)","message_RU": "Лёд"}],
	"s-3026-1000-1110-0": [{"type": "text","sub_type": "message","message": "Fire DOT (Away)","message_RU": "Огонь"}],
	"s-3026-1000-2112-0": [{"type": "text","sub_type": "message","message": "Air-conditioned DOT (away)","message_RU": "Лёд"}],
	"s-3026-1000-2110-0": [{"type": "text","sub_type": "message","message": "Fire DOT (Away)","message_RU": "Огонь"}],
	"s-3026-1000-1108-0": [{"type": "text","sub_type": "message","message": "Turn right (repel !!)","message_RU": "Поворот вправо (откид)"},{"type": "func","func": Spawnitem2.bind(null,912,0,0,8,440,100,2000)}],
	"s-3026-1000-2108-0": [{"type": "text","sub_type": "message","message": "Turn right (repel !!)","message_RU": "Поворот вправо (откид)"},{"type": "func","func": Spawnitem2.bind(null,912,0,0,8,440,100,2000)}],
	"s-3026-1000-1158-0": [{"type": "text","sub_type": "message","message": "Turn right (repel !!)","message_RU": "Поворот вправо (откид)"},{"type": "func","func": Spawnitem2.bind(null,912,0,0,8,440,100,2000)}],
	"s-3026-1000-2158-0": [{"type": "text","sub_type": "message","message": "Turn right (repel !!)","message_RU": "Поворот вправо (откид)"},{"type": "func","func": Spawnitem2.bind(null,912,0,0,8,440,100,2000)}],

	"s-3026-1000-1109-0": [{"type": "text","sub_type": "message","message": "Turn left (repel !!)","message_RU": "Поворот влево (откид)"},{"type": "func","func": Spawnitem2.bind(null,912,0,0,8,440,100,2000)}],
	"s-3026-1000-2109-0": [{"type": "text","sub_type": "message","message": "Turn left (repel !!)","message_RU": "Поворот влево (откид)"},{"type": "func","func": Spawnitem2.bind(null,912,0,0,8,440,100,2000)}],
	"s-3026-1000-1159-0": [{"type": "text","sub_type": "message","message": "Turn left (repel !!)","message_RU": "Поворот влево (откид)"},{"type": "func","func": Spawnitem2.bind(null,912,0,0,8,440,100,2000)}],
	"s-3026-1000-2159-0": [{"type": "text","sub_type": "message","message": "Turn left (repel !!)","message_RU": "Поворот влево (откид)"},{"type": "func","func": Spawnitem2.bind(null,912,0,0,8,440,100,2000)}],
	...
	"s-3026-1000-1154-0": [{"type": "text","sub_type": "message","message": "Ice storm","message_RU": "Ледяной шторм"},{"type": "func","func": Spawnitem2.bind(null,553,180,80,8,520,100,5000)}],   //30不可防
	"s-3026-1000-2154-0": [{"type": "text","sub_type": "message","message": "Ice storm","message_RU": "Ледяной шторм"},{"type": "func","func": Spawnitem2.bind(null,553,180,80,8,520,100,5000)}],   //30不可防
	...
	"s-3026-1000-1140-0": [{"type": "text","sub_type": "message","message": "40","message_RU":  "40° всем (Лёд)"}],
	"s-3026-1000-2140-0": [{"type": "text","sub_type": "message","message": "40","message_RU":  "40° всем (Лёд)"}],
	"s-3026-1000-1212-0": [{"type": "func","func": skilld_event.bind(null, 212)},{"type": "func","func": Spawnitem2.bind(null,553,0,0,8,440,200,6000)}],
	"s-3026-1000-1215-0": [{"type": "func","func": skilld_event.bind(null, 215)},{"type": "func","func": Spawnitem2.bind(null,553,0,0,8,440,200,6000)}],
	"s-3026-1000-1213-0": [{"type": "func","func": skilld_event.bind(null, 213)},{"type": "func","func": Spawnitem2.bind(null,553,0,0,8,440,200,6000)}],
	"s-3026-1000-1214-0": [{"type": "func","func": skilld_event.bind(null, 214)},{"type": "func","func": Spawnitem2.bind(null,553,0,0,8,440,200,6000)}],

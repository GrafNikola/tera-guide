...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3043-1000-106-0": [{ type: "text", sub_type: "message", message: "Push", message_RU: "Откид" }],
		"s-3043-1000-110-0": [{ type: "text", sub_type: "message", message: "Throw Front (Stun)", message_RU: "Удар вперед (стан)" }],
		...
		"s-3043-1000-124-0": [{ type: "text", sub_type: "message", message: "AoE", message_RU: "АоЕ" }],
		"s-3043-1000-125-0": [{ type: "text", sub_type: "message", message: "Hit | Frontal Stun", message_RU: "Удар | Передний стан" }],
		"s-3043-1000-126-0": [
		...
		"s-3043-1000-129-0": [{ type: "text", sub_type: "message", message: "Somersault | Back Hit", message_RU: "Кувырок | Удар назад" }],
		"s-3043-1000-130-0": [
		...
		"s-3043-1000-142-0": [{ type: "text", sub_type: "message", message: "Frontal Combo", message_RU: "Передняя комба" }],
		"s-3043-1000-301-0": [{ type: "text", sub_type: "message", message: "Circles (Target)", message_RU: "Круги (таргет)" }],
		"s-3043-1000-340-0": [
		...
		"s-3043-2000-106-0": [{ type: "text", sub_type: "message", message: "Push", message_RU: "Откид" }],
		"s-3043-2000-110-0": [{ type: "text", sub_type: "message", message: "Throw Front (Stun)", message_RU: "Удар вперед (стан)" }],
		...
		"s-3043-2000-124-0": [{ type: "text", sub_type: "message", message: "AoE", message_RU: "АоЕ" }],
		"s-3043-2000-125-0": [{ type: "text", sub_type: "message", message: "Hit | Frontal Stun", message_RU: "Удар | Передний стан" }],
		"s-3043-2000-126-0": [
			{ type: "text", sub_type: "message", message: "Frontal Stun", message_RU: "Передний стан" },
			{ type: "spawn", func: "vector", args: [553, 60, 220, 20, 500, 0, 2000] },
			{ type: "spawn", func: "vector", args: [553, 300, 220, 340, 500, 0, 2000] }
		],
		"s-3043-2000-129-0": [{ type: "text", sub_type: "message", message: "Somersault | Back Hit", message_RU: "Кувырок | Удар назад" }],
		"s-3043-2000-130-0": [
			{ type: "text", sub_type: "message", message: "Back Hit (Bleed)", message_RU: "Удар назад (кровоток)" },
			{ type: "spawn", func: "circle", args: [true, 553, 180, 340, null, 250, 0, 2000] }
		],
		"s-3043-2000-142-0": [{ type: "text", sub_type: "message", message: "Frontal Combo", message_RU: "Передняя комба" }],
		"s-3043-2000-143-0": [{ type: "text", sub_type: "message", message: "Hit | Back Push", message_RU: "Удар | Откид назад" }],
		"s-3043-2000-143-1": [{ type: "text", sub_type: "message", message: "Back Push", message_RU: "Откид назад" }],
		"s-3043-2000-144-0": [
		...
		"s-3043-2000-301-0": [{ type: "text", sub_type: "message", message: "Circles (Target)", message_RU: "Круги (таргет)" }],
		"s-3043-2000-340-0": [
			{ type: "text", sub_type: "message", message: "Laser", message_RU: "Лазер" },
			{ type: "spawn", func: "vector", args: [912, 90, 50, 25, 300, 0, 2000] },
			{ type: "spawn", func: "vector", args: [912, 270, 50, 335, 300, 0, 2000] }
		...
		"qb-3043-2000-3043201": [{ type: "text", sub_type: "message", message: "Blue Circles (Safe)", message_RU: "Синие круги (сейф-зона)" }],
		"qb-3043-2000-3043202": [{ type: "text", sub_type: "message", message: "Red Circles (Dodge)", message_RU: "Красные круги (эвейд)" }],
		"qb-3043-2000-3043400": [{ type: "text", sub_type: "message", message: "Break Statues", message_RU: "Разбить статуи" }]
	};
};
...
const { SpawnMarker, SpawnPoint, SpawnVector, SpawnCircle, SpawnSemicircle } = module.parent.exports.lib;
...
module.exports = {
	...
	"s-444-1000-2118-0": [
		{ "type": "text", "sub_type": "message", "message": "Jump (Tank)", "message_RU": "Прыжок (танк)" }

...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3044-2000-303-0": [
			{ type: "text", sub_type: "message", message: "Semicircle (Left Safe)", message_RU: "Полукруг (лево сейф)" },
			{ type: "spawn", func: "marker", args: [false, 250, 300, 0, 3000, true, null] },
			{ type: "spawn", func: "marker", args: [false, 70, 300, 0, 3000, true, null] }
		],
		"s-3044-2000-306-0": [
			{ type: "text", sub_type: "message", message: "Semicircle (Right Safe)", message_RU: "Полукруг (право сейф)" },

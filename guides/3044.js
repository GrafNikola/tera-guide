...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3044-2000-301-0": [{ type: "text", sub_type: "message", message: "Circles (Target)", message_RU: "Круги (таргет)" }],
		"s-3044-2000-340-0": [
			{ type: "text", sub_type: "message", message: "Laser", message_RU: "Лазер" },
			{ type: "spawn", func: "vector", args: [912, 90, 50, 25, 300, 0, 2000] },
			{ type: "spawn", func: "vector", args: [912, 270, 50, 335, 300, 0, 2000] }
		...
		"qb-3044-2000-3044201": [{ type: "text", sub_type: "message", message: "Blue Circles (Safe)", message_RU: "Синие круги (сейф-зона)" }],
